...
export class Entity{
    constructor(canvas, keys){
        ...
        window.addEventListener('touchstart', (e) => {
            ...
            this.initY = e.clientY || e.touches[0].clientX;
        });
        ...
        window.addEventListener('touchmove', (e) => {
            let draggedX = (e.clientX || e.touches[0].clientX) - this.initX;
            let draggedY = (e.clientY || e.touches[0].clientX) - this.initY;
        
            //clamps to joystickRange
            draggedX = (draggedX > 0) ? Math.min(this.joystickRange, draggedX): Math.max(-this.joystickRange, draggedX);
            draggedY = (draggedY > 0) ? Math.min(this.joystickRange, draggedY): Math.max(-this.joystickRange, draggedY);
        
            //scaling 0 to 1
            draggedX /= this.joystickRange;
            draggedY /= this.joystickRange;
            ...
            console.log(this.joystickX,this.joystickY);
        });
    }
